...
label = Label(frame, text="Goldra1n-c",font=('Helveticabold', 36))
label.place(x=190, y=50)

my_label2 = Label(frame,
                 text = "Designed for iOS 15.0 - 16.3")
...
cdetectDevice = cutk.CTkButton(master=frame,
                   text="Pair iDevice",
                   command=detectDevice,
                   fg_color='#999393')
cdetectDevice.place(x=50, y=150)

cbeginExploit12 = cutk.CTkButton(master=frame,
...
cexitRecovery = cutk.CTkButton(master=frame,
